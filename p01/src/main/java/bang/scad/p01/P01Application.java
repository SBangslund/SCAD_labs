...
public class P01Application {
	...
	public static void main(String[] args) {
		...
		TestHandler e1Tester = new TestHandler(invoker, "arn:aws:lambda:us-east-1:682613002205:function:p01_e1", e1Payload.toString(), 1);
		TestHandler e2Tester = new TestHandler(invoker, "arn:aws:lambda:us-east-1:682613002205:function:p01_e2", null, 1);
		TestHandler e7Tester = new TestHandler(invoker, "arn:aws:lambda:us-east-1:682613002205:function:p01_e7", null, 100);
